...
function About() {
  return (
    <>
      {/* 2. Add dynamic SEO meta tags for the About page */}
      <SEO 
        title="About Me | Software Engineer & Network Infrastructure Specialist"
        description="Learn more about Anselm Tumuhaise - Software Developer, Cisco Network Infrastructure Specialist, and AI enthusiast based in Kampala, Uganda."
        keywords="Anselm Tumuhaise, About Anselm, Software Engineer Uganda, Cisco Network Specialist, React Developer Kampala, Proxmox virtualization"
      />
